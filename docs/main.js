...
function showSlides(n) {
    var slides= document.getElementsByClassName("mySlides");//This takes all the elements with the class name and stores them in the variable array slides
    var dots=document.getElementsByClassName("dot"); //This takes all elements in the class and stores them in the variable array
